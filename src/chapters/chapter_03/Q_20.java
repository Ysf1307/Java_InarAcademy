...
public class Q_20 {
	...
	public static void main(String[] args) {
		...
		if (temperature < 41 && temperature > -58 && velocity > 2) {
			double coldness = 35.74 + (0.6215 * temperature) - (35.75 * Math.pow(velocity, 0.16))
					+ (0.4275 * temperature * Math.pow(velocity, 0.16));
			System.out.println("The Wind Chill Temperature: " + coldness);
		}
		else System.out.println("Your input is out of range");
	}
}